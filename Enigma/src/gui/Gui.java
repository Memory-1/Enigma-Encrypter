	...
	public Gui(JFrame frame) {
		...
		openFile.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
			   ...
			   fc.setFileFilter(new TxtFileFilterChooser());
			   fc.showDialog(frame, "Choose a file");
		...
		saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				String s = (String)JOptionPane.showInputDialog(frame, "Enter the name for your file") + ".txt";
				
				PrintWriter outputWriter;
				try {
					outputWriter = new PrintWriter(new FileWriter(s));
